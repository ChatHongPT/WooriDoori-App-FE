            ...
            <div className="mt-[1rem]">
                ...
                <div className="flex gap-[1rem] items-center">
                    ...
                    <button
                        ...
                        className={`font-medium underline transition ${isAvailable === true
                ...
                <button
                    ...
                    className={`px-[1rem] py-[0.8rem] float-right border rounded-lg text-[1rem] font-medium transition ${isVerified
